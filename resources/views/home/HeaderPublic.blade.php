<header>
    <div class="container-fluid"> <!--CONTAINER IN -->
        ...
        <div class="row"> <!--ROW-3 IN -->
            <div class="col-md-4">
                <div style="width: 50%;">
                <a href="https://github.com/AnnabelleNicole"><img class="img-fluid" src="{{ asset('image/RectangleText.png') }}"></a>
                </div>
            </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <nav>
            ...
            <a class="sidenav" href="https://github.com/AnnabelleNicole">Connecto.com</a>
            <a class="sidenav" href="mailto:contact@annabellenicole.ca">Nous joindre</a>
            @if(session()->has('emailUser'))
