                                ...
                                <div class="reportForm3">
                                    <h2 class="accordion-header" id="heading{{ $service->id }}">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            <ul><label for="service_{{ $service->id }}">{{ $service->name }}</label>
                                            </ul>
                                            <ul>{{ $report->date }}</ul>
                                        </button>
                                    ...
                                    <div id="collapse{{ $report->id }}" class="accordion-collapse collapse"
                                        ...
                                        <div class="mb-3 reportForm">
                                            <div class=""><strong>Commentaire: </strong>
                                                <br />{{ $report->detail }}
                                            </div>
                                            <div class=""><a
                                                    href="mailto:{{ $report->email }}">{{ $report->email }}</a>
                                            </div>
                                            <div class=""><strong>Problème courant: </strong>
                                                <br />{{ $report->frequent_issue->problem }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
